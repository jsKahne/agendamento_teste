            ...
            <div class="card2">
                <form class="form" action="login.php" method="post">
                    ...
                    <div class="field">
                        ...
                        <input type="text" class="input-field" placeholder="User" autocomplete= "off" name="username" required>
                    </div>
                    <div class="field">
                        <svg viewBox="0 0 16 16" fill="currentColor" height="16" width="16" xmlns="http://www.w3.org/2000/svg" class="input-icon">
                    ...
                    <div class="btn">
                        ...
                        <a href="forgot_password.php"><button class="button2" type="">Esqueci Minha Senha</button></a>
                    </div>       
        </form>
